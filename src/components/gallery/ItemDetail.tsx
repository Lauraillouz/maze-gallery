          ...
          <div className="mt-auto flex items-center justify-between gap-4 pt-2" style={{ borderTop: `1px solid ${accent}22` }}>
            {item.forSale && item.price !== undefined ? (
              <>
                ...
                <button onClick={() => { addItem(item); close(); }} className="px-4 py-2 font-grotesk text-[10px] font-bold uppercase tracking-widest text-[#08000F] touch-manipulation" style={{ background: accent }}>Add to cart</button>
              </>
            ) : (
