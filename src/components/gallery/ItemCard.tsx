  ...
  return (
    ...
    >
      ...
      {item.forSale && item.price !== undefined && (
        <div className="absolute bottom-2 right-2 font-grotesk text-[8px] font-bold" style={{ color: accent }}>
          ${item.price.toLocaleString()}
        </div>
      )}

      {item.editionSize && (
        <div className="absolute left-2 top-2 font-grotesk text-[7px] uppercase tracking-wide" style={{ color: `${accent}88` }}>
